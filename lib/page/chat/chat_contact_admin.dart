...
class ChatContactSelectorViewAdmin extends StatefulWidget {
  const ChatContactSelectorViewAdmin({super.key});

  @override
  State<ChatContactSelectorViewAdmin> createState() =>
      _ChatContactSelectorViewAdminState();
}

class _ChatContactSelectorViewAdminState extends State<ChatContactSelectorViewAdmin> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: Obx(() {
              if (chatService.isLoading.value && chatService.Users.isEmpty) {
                //Loading teacher
                return Center(
                  child: Column(
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 16),
                      ElevatedButton(
                        onPressed: () => chatService.fetchAllUsers(),
                        style: ElevatedButton.styleFrom(
                          backgroundColor: Color(0xFFf66890),
                          foregroundColor: Colors.white,
                        ),
              ...
              return RefreshIndicator(
                ...
                onRefresh: () => chatService.fetchAllUsers(),
  ...
  void _handleUserTap(UserModel user) async {
